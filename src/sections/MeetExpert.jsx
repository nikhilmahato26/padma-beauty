      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 grid lg:grid-cols-12 gap-12 items-center">
        ...
        >
          <h2 className="h-display text-5xl md:text-6xl lg:text-7xl text-ink leading-[0.95] mb-3">
            Meet The Expert<br />
            Behind <span className="italic">Padma.</span>
          </h2>
          ...
          <p className="text-ink/65 text-[14px] leading-relaxed mb-8">
            Her journey began with a love for creativity and connection. Today, she combines her expertise with a personalised approach to deliver results that go beyond skin-deep — at Padma Makeover Beauty Parlour.
          </p>
